...
public class TourPriceHistoryControllerTest {
    ...
    void findByTourPlanIdAndChangedAtBetween_success() throws Exception {
        ...
        when(service.findByTourPlanIdAndChangedAtBetween(eq(tourPlanId), any(LocalDateTime.class), any(LocalDateTime.class)))
        ...
        verify(service).findByTourPlanIdAndChangedAtBetween(eq(tourPlanId), any(LocalDateTime.class), any(LocalDateTime.class));
    }
    ...
    void getPriceChangesByUserAndDateRange_success() throws Exception {
        ...
        verify(service).getPriceChangesByUserAndDateRange(eq(userId), any(LocalDateTime.class), any(LocalDateTime.class));
    }
