...
public class DataProvider {
        ...
        public static AddressRequest addressRequestMock = new AddressRequest("Street One", "1111", 1,
                        "Additional info");
        ...
        public static TourPlan tourPlanOneMock = TourPlan.builder()
                        ...
                        .pricing(TourPlanPricing.builder()
        ...
        public static TourAssignmentResponse tourAssignmentResponseMock = new TourAssignmentResponse(
                        tourAssignmentOneMock);
        ...
        public static List<TourPriceHistoryRequest> tourPriceHistoryRequestListForBulkCreateMock() {
                return List.of(
                                new TourPriceHistoryRequest(1, BigDecimal.valueOf(105.00), BigDecimal.valueOf(115.00),
                                                1L,
                                                "Bulk create 1"),
                                new TourPriceHistoryRequest(2, BigDecimal.valueOf(230.00), BigDecimal.valueOf(240.00),
                                                2L,
                                                "Bulk create 2"),
                                new TourPriceHistoryRequest(3, BigDecimal.valueOf(320.00), BigDecimal.valueOf(310.00),
                                                3L,
                                                "Bulk create 3"));
        }
        ...
        public static List<TourPriceHistoryRequest> tourPriceHistoryRequestListForBulkUpdateMock() {
                return List.of(
                                new TourPriceHistoryRequest(1, BigDecimal.valueOf(115.00), BigDecimal.valueOf(125.00),
                                                1L,
                                                "Bulk update 1"),
                                new TourPriceHistoryRequest(2, BigDecimal.valueOf(240.00), BigDecimal.valueOf(250.00),
                                                2L,
                                                "Bulk update 2"));
        }
        ...
        public static List<TourPriceHistory> tourPriceHistoryListForStatisticsMock() {
                return List.of(
                                ...
                                TourPriceHistory.builder().id(1).tourPlan(tourPlanOneMock)
                                                .previousPrice(BigDecimal.valueOf(100.00))
                                                .newPrice(BigDecimal.valueOf(120.00))
                                                .changedAt(LocalDateTime.now().minusDays(10))
                                                .changedBy(userAdmin()).reason("Increase").build(),
                                TourPriceHistory.builder().id(2).tourPlan(tourPlanOneMock)
                                                .previousPrice(BigDecimal.valueOf(120.00))
                                                .newPrice(BigDecimal.valueOf(110.00))
                                                .changedAt(LocalDateTime.now().minusDays(8))
                                                .changedBy(userOperator()).reason("Decrease").build(),
                                TourPriceHistory.builder().id(3).tourPlan(tourPlanOneMock)
                                                .previousPrice(BigDecimal.valueOf(110.00))
                                                .newPrice(BigDecimal.valueOf(95.00))
                                                .changedAt(LocalDateTime.now().minusDays(5))
                                                .changedBy(userAdmin()).reason("Decrease").build(),
                                TourPriceHistory.builder().id(4).tourPlan(tourPlanOneMock)
                                                .previousPrice(BigDecimal.valueOf(95.00))
                                                .newPrice(BigDecimal.valueOf(105.00))
                                                .changedAt(LocalDateTime.now().minusDays(2))
                                ...
                                TourPriceHistory.builder().id(5).tourPlan(tourPlanTwoMock)
                                                .previousPrice(BigDecimal.valueOf(200.00))
                                                .newPrice(BigDecimal.valueOf(250.00))
                                                .changedAt(LocalDateTime.now().minusDays(12))
                                                .changedBy(userAdmin()).reason("Increase").build(),
                                TourPriceHistory.builder().id(6).tourPlan(tourPlanTwoMock)
                                                .previousPrice(BigDecimal.valueOf(250.00))
                                                .newPrice(BigDecimal.valueOf(230.00))
                                                .changedAt(LocalDateTime.now().minusDays(9))
                                                .changedBy(userContentManager()).reason("Decrease").build(),
                                TourPriceHistory.builder().id(7).tourPlan(tourPlanTwoMock)
                                                .previousPrice(BigDecimal.valueOf(230.00))
                                                .newPrice(BigDecimal.valueOf(270.00))
                                                .changedAt(LocalDateTime.now().minusDays(6))
                                                .changedBy(userOperator()).reason("Increase").build(),
                                TourPriceHistory.builder().id(8).tourPlan(tourPlanTwoMock)
                                                .previousPrice(BigDecimal.valueOf(270.00))
                                                .newPrice(BigDecimal.valueOf(260.00))
                                                .changedAt(LocalDateTime.now().minusDays(3))
                                                .changedBy(userAdmin()).reason("Decrease").build());
