...
class SecurityIntegrationTest {
        ...
        class AuthorizationTests {
                ...
                void protectedEndpoint_shouldThrowException_whenBearerTokenIsEmpty() {
                        assertThrows(Exception.class, () -> mockMvc.perform(get("/api/user")
        ...
        class RoleBasedAccessControlTests {
                ...
                @Test
                @DisplayName("Should deny CUSTOMER access to Marketing Campaigns write endpoints")
                void marketingCampaigns_shouldDeny_whenUserIsCustomer() throws Exception {
                        String token = generateTokenForRole(RoleEnum.CUSTOMER, "customer");
                ...
                @Test
                @DisplayName("Should deny CUSTOMER access to Campaign Tours write endpoints")
                void campaignTours_shouldDeny_whenUserIsCustomer() throws Exception {
                        String token = generateTokenForRole(RoleEnum.CUSTOMER, "customer");
