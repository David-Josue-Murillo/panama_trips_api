...
@Table(name = "providers", indexes = {
        @Index(name = "idx_provider_province", columnList = "province_id"),
        @Index(name = "idx_provider_district", columnList = "district_id"),
        @Index(name = "idx_provider_address", columnList = "address_id")
})
